...
|---|---|---|---|---|---|
| Clean-root publication excludes legacy commits and private evidence | Required | Distinct repository and Git database | Final full-ref audit | README status and dated publication evidence | Validated; see dated evidence |
